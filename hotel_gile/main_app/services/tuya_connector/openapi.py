...
class TuyaOpenAPI:
    ...
    def __request(
        ...
        headers = {"client_id": self.access_id, "sign": sign, "sign_method": "HMAC-SHA256",
                   "access_token": access_token, "t": str(t), "lang": self.lang, "dev_lang": "python",
                   "dev_version": VERSION, "dev_channel": f"cloud_{self.dev_channel}"}
